<?php
/**
 * REST API: SP_REST_Attachments_Controller class
 *
 * @author   StorePilot
 * @category API
 ...
 */
class SP_REST_Attachments_Controller extends SP_REST_Posts_Controller {
	...
	/**
	 * Register the routes for attackments.
	 */
	...
	public function create_item_permissions_check( $request ) {
		...
		rest_send_cors_headers( null ); // Allow cors when uploading
		return true;
	}
